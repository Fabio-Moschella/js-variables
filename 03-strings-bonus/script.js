...
console.log(citySubstring.substring(3)); // Output: "York"

// 3. Sostituzione
// Sostituisci 'York' con 'Delhi'
const cityReplaced = "New York";
...
const cityNameConcat = city;
console.log(cityNameConcat.concat(" ", cityName)); // Output: "New York City"

// 5. Tutto in maiscolo
// Trasforma tutto in maiscuolo la stringa della variabile hello
const upperCaseHello = "hello";
console.log(upperCaseHello.toLocaleUpperCase("en-US")); // Output: "HELLO"
